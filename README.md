...
* 3 - Caso não tenha instalado na sua máquina o Java, precisará dele, **JRE**(só para executar o projeto) ou **JDK**(modificar/desenvolver e compilar o projeto), facilmente encontrado na internet.
* 4 - Caso opte por uma IDE, como por exemplo [Intellij CE](https://www.jetbrains.com/idea/download/), escolha a versão **IntelliJ IDEA Community Edition**
